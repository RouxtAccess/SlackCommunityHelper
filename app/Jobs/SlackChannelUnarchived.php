...
class SlackChannelUnarchived implements ShouldQueue
{
    ...
    public function sendChannelLogMessage()
    {
        resolve(SlackService::class)->sendMessage(
            ...
            text: ":open_book: <@" . Arr::get($this->eventData, 'user') . "> unarchived channel <#" . Arr::get($this->eventData, 'channel') .">",
            blocks: [],
            emoji: 'arrow_up',
            username: config('services.slack.bot_user_name') . ' - Channel Unarchived'
        );
    }
}

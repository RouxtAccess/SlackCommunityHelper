...
<div class="site-wrapper overflow-hidden position-relative">
    ...
    <!--Site Header Area -->
    <header class="site-header site-header--menu-left landing-11-menu site-header--absolute">
        <div class="container">
            <nav class="navbar site-navbar">
                <!-- Brand Logo-->
                <div class="brand-logo" style="display: flex;align-items: center;">
                    <img src="logo.png" alt="" class="light-version-logo" style="max-width: 50px;display: inline;">
                    <h3 style="display: inline;margin:0;transform: translateY(9px);margin-left: 3px">CommunityBot</h3>
                </div>
            </nav>
        </div>
    </header>
        ...
        <div class="container position-relative">
            <div class="row position-relative justify-content-center">
                <div class="col-xl-8 col-lg-9 col-md-12 order-lg-1 order-1" data-aos="fade-up" data-aos-duration="500" data-aos-once="true">
                    <div class="content">
                        <h1>Slack App<br class="d-none d-md-block"> built for Communities</h1>
                        <div class="row banner-l-11-bottom-content">
                            <div class="col-lg-8 col-md-8 col-sm-10">
                                <p class="position-relative banner-main-content-l-11">Manage and maintain your slack community with less headaches and more transparency.
                                    <span class="line-left-content"></span>
                                </p>
                            </div>
                            <div class="col-lg-4 col-md-4 col-sm-6 flex-y-center ">
                                <a href="https://slack.com/oauth/v2/authorize?client_id=1908518842130.4017448321297&scope=app_mentions:read,channels:history,channels:join,channels:read,chat:write,chat:write.customize,groups:history,groups:read,reactions:read,team:read,usergroups:read,users:read,channels:manage,groups:write&user_scope=admin,chat:write">
            ...
            <div class="row align-items-center justify-content-lg-start justify-content-center">
                ...
                <div class="offset-xxl-1 col-xxl-5 col-xl-6 col-lg-7 col-md-9" data-aos="fade-left" data-aos-duration="800" data-aos-once="true">
                    <div class="content section-heading-5">
                        ...
                        <p>We can automatically log changes to channels, log when messages are edited or deleted.</p>
                        <p>We also help manage automatic invites for your slack group and make sure that your invite process is preserved</p>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="content section-heading-5">
                        ...
                        <div class="d-flex content-l-11-3-card">
                            ...
                            <div class="content-body">
                                ...
                                <p>Setup CommunityBot within a minute. Just a slack install and then enable features.</p>
                            </div>
                        </div>
                        <div class="d-flex content-l-11-3-card">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-10 text-center">
                            <div class="section-heading-5">
                                <h2>
                                    One Bot, Many Options
                                </h2>
                                <p>We know that not everything is suited for everyone. So by default all features are deactivated and you can pick and choose what you'd like for your own space</p>
                            </div>
                        </div>
                    </div>
                    <div class="row feature-l-11-items justify-content-center">
                        <div class="col-md-6" data-aos="fade-right" data-aos-duration="800" data-aos-once="true">
                            <div class="d-flex ">
                                ...
                                <div class="content-body">
                                    <h5>User Update Log</h5>
                                    <p>Keep a track of your member's name changes. Let nothing nefarious slip past you!</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6" data-aos="fade-left" data-aos-duration="800" data-aos-once="true">
                            <div class="d-flex ">
                                ...
                                <div class="content-body">
                                    <h5>Channel Updates</h5>
                                    <p>Let your team know whenever a channel is created/renamed/deleted/archived/unarchived!</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6" data-aos="fade-right" data-aos-duration="1000" data-aos-once="true">
                            <div class="d-flex ">
                                ...
                                <div class="content-body">
                                    <h5>Message Rules</h5>
                                    <p>Easily set rules as to who is able to send messages in a thread or channel</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6" data-aos="fade-left" data-aos-duration="1000" data-aos-once="true">
                            <div class="d-flex ">
                                ...
                                <div class="content-body">
                                    <h5>Message Logs</h5>
                                    <p>Keep track of message edit/deletes in your workspace.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6" data-aos="fade-right" data-aos-duration="1200" data-aos-once="true">
                            <div class="d-flex ">
                                ...
                                <div class="content-body">
                                    <h5>User Joined Log</h5>
                                    <p>Log whenever someone joins your workspace.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6" data-aos="fade-left" data-aos-duration="1200" data-aos-once="true">
                            <div class="d-flex ">
                                ...
                                <div class="content-body">
                                    ...
                                    <p>If you want 1 feature or all of them, it's up to your admin team to decide.</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="text-center">
                        <p>© RouxtAccess 2022 All right reserved. </p>
                    </div>
                </div>
            </div>
        </div>
